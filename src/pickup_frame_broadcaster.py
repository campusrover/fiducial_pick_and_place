...
class PickupFrameBroadcaster:
    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            try:
                tf_cargo = self.tf_buffer.lookup_transform('fiducial_1', 'fiducial_1', rospy.Time()).transform
                ...
                tf_cargo_to_base_link = self.tf_buffer.lookup_transform('fiducial_1', 'px100/base_link', rospy.Time()).transform 
